...
export const faqData: FAQ[] = [
  {
    ...
    "answer": {
      "text": "Common risks include phishing scams, ransomware, weak or reused passwords, and unpatched software, including applications. According to the ACSC Annual Cyber Threat Report 2024-25, the average cost of a cyber incident to a small business is approximately $56,600.",
