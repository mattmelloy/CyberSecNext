...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    "answers": [
      ...
      {
        "text": "C) Never. Ee restore only when something breaks.",
        "points": 3,
  ...
  },
  {
    ...
    "answers": [
      ...
      {
        "text": "B) Yes, but we still see quite a few spam emails come through.",
        "points": 5,
      ...
      {
        "text": "C) No, we don’t have anything and get a lot of spam.",
        "points": 2,
  ...
  },
  {
    ...
    "answers": [
      ...
      {
        "text": "C) No, we don’t use AntiVirus.",
        "points": 2,
  ...
  },
  {
    ...
    "question": "Is your business Wi-Fi locked with a strong password so only your team can use it?",
    "answers": [
      {
      ...
      {
        "text": "B) Yes, but it’s simple or shared with others including customers.",
        "points": 4,
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "A) Yes, they all auto-lock with passwords or PINs.",
        "points": 10,
  ...
  },
  {
    ...
    "question": "Do you verify payment requests or changes to banking details through a separate channel (like a phone call)?",
    "answers": [
      {
        "text": "A) Yes, we always verify via phone or another trusted channel before acting.",
        "points": 10,
        "feedback": "Excellent! Verifying payment requests through a separate channel is your best defense against Business Email Compromise (BEC). This is the #1 cause of financial loss from cybercrime in Australia. To maintain this:\n\n- **Keep Contact Lists Updated**: Maintain a verified list of supplier contacts.\n- **Train Staff**: Ensure everyone knows the verification rule—no exceptions.\n- **Use Code Words**: Consider using verbal confirmation codes for high-value transfers.\n\nYou're protecting your business from one of the most costly scams—keep it up!"
      },
      {
        "text": "B) Sometimes, but not consistently.",
        "points": 5,
        "feedback": "Inconsistent verification is like locking your door sometimes—hackers only need one opportunity. BEC scammers target Australian businesses daily, with average losses over $50,000.\n\n**Steps to Fix This**:\n1. **Make It a Rule**: 'All payment changes must be verified by phone.'\n2. **Create a Checklist**: Add verification to your payment process.\n3. **Use Known Numbers**: Call the number you have on file, not one from the email.\n4. **Train Staff**: Share examples of BEC scams with your team.\n\nConsistent verification stops scammers cold—make it non-negotiable!"
      },
      {
        "text": "C) No, we trust the emails we receive.",
        "points": 0,
        "feedback": "This is extremely risky! Email addresses can be spoofed or hacked. BEC is the top financial cyber threat to Australian businesses, with losses in the millions each year.\n\n**Steps to Fix This**:\n1. **Never Trust Email Alone**: Always verify payment changes by phone.\n2. **Check for Red Flags**: Urgent requests, new bank details, slight email changes.\n3. **Call Known Numbers**: Use the number you have on file, not from the email.\n4. **Delay Payments**: Build in time for verification.\n5. **Report Suspicious Emails**: Forward to report@scamnet.net.au\n\nVerification takes minutes but saves thousands—start today!"
      },
      {
        "text": "D) I'm not sure what BEC is.",
        "points": 2,
        "feedback": "Business Email Compromise (BEC) is when scammers impersonate suppliers, executives, or staff to trick you into transferring money. It's the #1 cause of cyber financial loss in Australia.\n\n**Steps to Fix This**:\n1. **Learn the Signs**: Urgent payment requests, new bank details, slightly changed email addresses.\n2. **Verify Everything**: Call the sender using a known number before acting.\n3. **Train Your Team**: Share this knowledge with staff.\n4. **Set a Policy**: 'Verify all payment changes by phone.'\n\nUnderstanding BEC is your first defense—learn it today!"
      }
    ]
  },
  {
    ...
    "question": "Do you use multi-factor authentication (MFA) on your cloud services (Microsoft 365, Google Workspace, etc.)?",
    "answers": [
      {
        "text": "A) Yes, MFA is enabled on all cloud accounts.",
        "points": 10,
        "feedback": "Perfect! MFA on cloud services is essential—these accounts contain your emails, documents, and business data. To keep it strong:\n\n- **Use Authenticator Apps**: Microsoft Authenticator or Google Authenticator are more secure than SMS.\n- **Review Access**: Regularly check who has admin access.\n- **Monitor Sign-ins**: Enable alerts for unusual login locations.\n\nYou're protecting your business's digital assets—excellent work!"
      },
      {
        "text": "B) MFA is on some accounts but not all.",
        "points": 5,
        "feedback": "Partial MFA leaves gaps—hackers only need one unprotected account. Email accounts are especially valuable targets.\n\n**Steps to Fix This**:\n1. **List All Cloud Services**: Microsoft 365, Google, Xero, etc.\n2. **Enable MFA on Each**: Start with email, then finance tools.\n3. **Use Authenticator Apps**: More secure than SMS codes.\n4. **Set a Deadline**: Complete within 1 week.\n\nComplete MFA coverage closes a major security gap—finish the job!"
      },
      {
        "text": "C) No, we just use passwords.",
        "points": 0,
        "feedback": "This is a critical risk! Cloud accounts with only passwords are prime targets. Once hacked, attackers can access emails, files, and impersonate you.\n\n**Steps to Fix This**:\n1. **Start with Email**: Enable MFA on Microsoft 365 or Google Workspace today.\n2. **Then Finance**: Add MFA to Xero, MYOB, banking.\n3. **Use Authenticator Apps**: Download Microsoft or Google Authenticator.\n4. **Train Staff**: Ensure everyone sets up MFA.\n\nMFA is the single most effective protection for cloud accounts—enable it now!"
      },
      {
        "text": "D) I'm not sure if we use cloud services.",
        "points": 2,
        "feedback": "If you use email (Gmail, Outlook), store files online, or use web-based software, you're using cloud services. These need protection.\n\n**Steps to Fix This**:\n1. **List Your Tools**: Email, file storage, accounting, CRM.\n2. **Check Each**: Is MFA enabled? (Look in security settings).\n3. **Enable MFA**: Turn it on for every service.\n4. **Ask IT**: 'Is MFA enabled on our accounts?'\n\nUnderstanding your cloud footprint is step one—find out today!"
      }
    ]
  },
  {
    ...
    "question": "Do staff who work from home follow specific security rules (like using VPNs or secure Wi-Fi)?",
    "answers": [
      {
        "text": "A) Yes, we have clear remote work security policies and tools in place.",
        "points": 10,
        "feedback": "Excellent! Remote work security is crucial as home networks are often less secure than office networks. To maintain this:\n\n- **Provide VPN Access**: Ensure staff connect through a VPN for work tasks.\n- **Secure Home Wi-Fi**: Require strong passwords on home routers.\n- **Use Company Devices**: Avoid work on personal computers when possible.\n\nYou're protecting your business wherever your team works—great job!"
      },
      {
        "text": "B) We have some rules but they're not enforced consistently.",
        "points": 5,
        "feedback": "Inconsistent remote security creates risk. Home networks, public Wi-Fi, and personal devices can all be entry points for attackers.\n\n**Steps to Fix This**:\n1. **Write a Policy**: 'Work devices only,' 'No public Wi-Fi without VPN.'\n2. **Provide a VPN**: Set up VPN access for all remote staff.\n3. **Train Staff**: Explain why home Wi-Fi needs strong passwords.\n4. **Check Compliance**: Ask staff to confirm their setup.\n\nConsistent remote security protects your business—formalize it today!"
      },
      {
        "text": "C) No, staff use their own devices and networks without rules.",
        "points": 0,
        "feedback": "This is a significant risk! Personal devices and unsecured networks can expose your business data to malware and hackers.\n\n**Steps to Fix This**:\n1. **Create a Policy**: Minimum requirements for remote work.\n2. **Provide Devices**: Issue company laptops if possible.\n3. **Set Up VPN**: Require VPN for all remote access.\n4. **Ban Public Wi-Fi**: Or require VPN when using it.\n5. **Train Staff**: Security basics for working from home.\n\nRemote work security is essential—start building it today!"
      },
      {
        "text": "D) We don't have remote workers.",
        "points": 8,
        "feedback": "Good—this reduces your attack surface. However, consider:\n\n- **Future Planning**: If remote work becomes needed, have a plan ready.\n- **Mobile Devices**: Staff may still check email on phones—ensure MFA.\n- **Travel**: Staff traveling may work remotely—set ground rules.\n\nBeing prepared keeps you secure if circumstances change!"
      }
    ]
  },
  {
    ...
    "question": "Do you check the security practices of vendors or suppliers who have access to your data or systems?",
    "answers": [
      {
        "text": "A) Yes, we review vendor security before engaging and periodically after.",
        "points": 10,
        "feedback": "Excellent! Supply chain attacks are growing—hackers target smaller vendors to reach bigger targets. To maintain this:\n\n- **Ask for Security Policies**: Vendors should have basic security measures.\n- **Limit Access**: Give vendors only the access they need.\n- **Review Annually**: Check that vendors maintain their security.\n\nYou're protecting your business through your partnerships—great work!"
      },
      {
        "text": "B) We check sometimes but not systematically.",
        "points": 5,
        "feedback": "Inconsistent vendor checks leave gaps. A vendor breach can expose your data even if your security is strong.\n\n**Steps to Fix This**:\n1. **List Vendors with Access**: IT providers, accountants, cloud services.\n2. **Ask Questions**: 'How do you protect our data?' 'Do you have MFA?'\n3. **Limit Access**: Give minimum necessary access.\n4. **Set Review Dates**: Annual check-ins on vendor security.\n\nSystematic vendor checks close a hidden security gap—start today!"
      },
      {
        "text": "C) No, we trust our vendors to handle security.",
        "points": 2,
        "feedback": "Blind trust in vendors is risky. Supply chain attacks are increasing—hackers target vendors as a way into their clients.\n\n**Steps to Fix This**:\n1. **List Your Vendors**: Who has access to your data or systems?\n2. **Ask Questions**: 'What security measures do you have?'\n3. **Check for Basics**: MFA, encryption, backups.\n4. **Limit Access**: Only what's necessary.\n5. **Get It in Writing**: Include security requirements in contracts.\n\nYour vendors' security affects yours—start asking questions!"
      },
      {
        "text": "D) I'm not sure who has access to our data.",
        "points": 2,
        "feedback": "Not knowing who has access to your data is like not knowing who has keys to your business. This needs attention.\n\n**Steps to Fix This**:\n1. **Audit Access**: List all software and services you use.\n2. **Identify Vendors**: Who provides each service?\n3. **Check Permissions**: What data can each vendor access?\n4. **Remove Unnecessary Access**: Revoke what's not needed.\n\nKnowing your data footprint is step one—find out today!"
      }
    ]
  },
  {
    ...
    "question": "Does your business have cyber insurance or know what your existing insurance covers for cyber incidents?",
    "answers": [
      {
        "text": "A) Yes, we have dedicated cyber insurance that covers incidents and response.",
        "points": 10,
        "feedback": "Excellent! Cyber insurance is an important safety net. It can cover incident response costs, legal fees, and even ransomware recovery. To maximize this:\n\n- **Know Your Coverage**: What incidents are covered? What's the limit?\n- **Keep Contacts Handy**: Know who to call if you need to make a claim.\n- **Review Annually**: Ensure coverage keeps pace with your business.\n\nYou've got a financial safety net for cyber incidents—great planning!"
      },
      {
        "text": "B) We have some coverage but I'm not sure of the details.",
        "points": 5,
        "feedback": "Partial knowledge of your coverage is better than none, but you need to know the details before an incident occurs.\n\n**Steps to Fix This**:\n1. **Find Your Policy**: Locate your insurance documents.\n2. **Check for Cyber Coverage**: Is it included? What's covered?\n3. **Note the Limits**: What's the maximum payout?\n4. **Save the Claims Number**: Keep it with your incident response plan.\n\nKnowing your coverage helps you respond effectively—check today!"
      },
      {
        "text": "C) No, we don't have cyber insurance.",
        "points": 3,
        "feedback": "Without cyber insurance, you're bearing the full financial risk of a cyber incident. The average cost to a small business can exceed $50,000.\n\n**Steps to Fix This**:\n1. **Assess Your Risk**: Do you handle sensitive data? Process payments?\n2. **Get Quotes**: Talk to your broker about cyber coverage.\n3. **Compare Options**: Coverage can start from a few hundred dollars/year.\n4. **Consider the Basics**: Even basic coverage helps with incident response.\n\nCyber insurance is increasingly important—explore your options!"
      },
      {
        "text": "D) I'm not sure if we have insurance or what it covers.",
        "points": 2,
        "feedback": "Not knowing your insurance status is like not knowing if you have a fire extinguisher. Find out what protection you have.\n\n**Steps to Fix This**:\n1. **Ask Your Broker**: 'Do we have cyber coverage?'\n2. **Check Your Policy**: Look for 'cyber' or 'data protection' clauses.\n3. **Assess Your Need**: Could you afford a $50,000 incident?\n4. **Get Covered**: If not, explore options.\n\nKnowing your coverage is part of being prepared—find out today!"
      }
    ]
  }
];